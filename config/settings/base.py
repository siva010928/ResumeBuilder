...
# ------------------------------------------------------------------------------
# Django Admin URL.
ADMIN_URL = "check/admin/"
# https://docs.djangoproject.com/en/dev/ref/settings/#admins
ADMINS = [("""Siva Prakash""", "siva010928@gmail.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Check API",
    "DESCRIPTION": "Documentation of API endpoints of `Check`",
    "VERSION": "1.0.0",
